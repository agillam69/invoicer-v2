...
DESTINATIONS = (
    "Dashboard", "New Invoice", "Invoices", "Payments & Receipts",
    "Clients", "Products & Services", "Income & Expenses", "Reports",
)
...
class MainWindow(QMainWindow):
    ...
    def _build_menu(self) -> None:
        ...
        for label in ("Settings", "Import/Migrate", "Export", "Backup Now", "Restore",
                      "Users", "Audit Log", "App Log", "Help", "About"):
